...
![tab:badexampleuntrimmed](images/bad_example.png)
...
![](images/bad_qcdemo_R2_quality_trimmed.png)
...
`bad_example.fastq`
![Per base sequence quality plot for the fixed-length trimmed](images/bad_example_trimmed_to_80bp.png)
